...
export class SupportChatController {
  ...
  async escalate(@Req() req: any, @Param('id') id: string) {
    ...
    this.supportChatGateway.notifyAdmins(
      'support:new_waiting',
      { conversation },
  ...
  @IsAdmin()
  async getAdminConversations(@CurrentUser() actor: MarketActor) {
    const data = await this.supportChatService.getAdminConversation(actor);
